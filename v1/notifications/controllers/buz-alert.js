...
function Buz_alert(req, res) {
    const { phone, sender, amount, desc, sender_balance, sender_email, type, receiver, means, receiver_balance, receiver_email,date } = req.body;
    if (!sender) return res.send("Provide all parameters")
                      ...
                      <section class="email-container" style='font-family: Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;
                        ...
                        <div style="background-color: #90b3cd;padding: 10px 30px;">
                          ...
                          <div class="" style="padding: ; font-family: sans-serif">
                            ...
                            <p
                              ...
                              Hi ${sender}, You have sent the sum of ₦${amount}.00 to ${receiver} via ${means}.
                            </p>
                          </div> <br>
                        </div>
                        ...
                        <div style="color: #9eb0b7;background-color:#f4f6f8; padding:10px;font-family: Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-size: 13px;
                          ...
                          <div style="margin: 10px 0px;">
                            Alert via:<div style="display: inline-block;width: 70%;text-align: left;float: right" > <b style="float: ;"> ${means} </b></div>
                          </div>
                          <div style="margin: 10px 0px;">
                            Amount: <div style="display: inline-block;width: 70%;text-align: left;float: right" ><b style="float: ;">₦${amount}</b></div>
                          </div>
                          <div style="margin: 10px 0px;">
                            Name of Recipient: <div style="display: inline-block;width: 70%;text-align: left;float: right" ><b style="float: ;">${receiver}</b></div>
                          </div>
                          <!-- <div style="margin: 10px 0px;">
                          ...
                          <div style="margin: 10px 0px;">
                            Current Balance:<div style="display: inline-block;width: 70%;text-align: left;float: right" ><b style="float: ;"> ₦${sender_balance}</b></div>
                          </div>
    ...
    request
        .then((result) => {
            //  send email to who is receiving the money
                  ...
                  <section class="email-container" style='font-family: Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;
                    ...
                    <div style="background-color: #90b3cd;padding: 10px 30px;">
                      ...
                      <div class="" style="padding: ; font-family: sans-serif">
                        ...
                        <p
                          style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen-Sans,Ubuntu,Cantarell,'Helvetica Neue',sans-serif;">
                          Hi ${receiver}, You have received the sum of ₦${amount}.00 from ${sender} via ${means}.
                        </p>
                      </div> <br>
                    </div>
                    ...
                    <div style="color: #9eb0b7;background-color:#f4f6f8; padding:10px;font-family: Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-size: 13px;
                      ...
                      <div style="margin: 10px 0px;">
                        Name of Sender: <div style="display: inline-block;width: 70%;text-align: left;float: right" ><b style="float: ;">${sender}</b></div>
                      </div>
                      <!-- <div style="margin: 10px 0px;">
                        Bank of Recipient: <div style="display: inline-block;width: 70%;text-align: left;float: right" ><b style="float: ;">Access Bank</b></div>
                      </div> -->
                      ...
                      <div style="margin: 10px 0px;">
                        Current Balance:<div style="display: inline-block;width: 70%;text-align: left;float: right" ><b style="float: ;"> ₦${receiver_balance}</b></div>
                      </div>
