...
function Create_cashtoken(req, res) {
    const { amount, token, user, email } = req.body;
    if (!email) return res.send("Provide all parameters")
                        ...
                        <div style="background-color: #90b3cd;padding: 10px 30px;">
                          ...
                          <div class="" style="padding: ; font-family: sans-serif">
                            ...
                            <p
                              ...
                              Hi ${user}, You have successfully created a cash token of ₦${amount}.
                            </p>
                          </div> <br>
                        </div>
                    <!-- #f4f6f8 -->
                        <div style="color: #9eb0b7;background-color:#f4f6f8; padding:10px;font-family: Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-size: 13px;
                                            font-weight: 300;text-align: center;height:100px;position: relative;">
                          <br>
                          <b style="font-size:30px;position: absolute;top:45%;width: 100%;margin: auto;right:0%"> ${token} </b> 
                        </div> <br>
